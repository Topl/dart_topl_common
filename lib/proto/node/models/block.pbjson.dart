...
const BlockBody$json = {
  ...
  '2': [
    ...
    {'1': 'rewardTransactionId', '3': 2, '4': 1, '5': 11, '6': '.co.topl.brambl.models.TransactionId', '10': 'rewardTransactionId'},
  ],
};
...
final $typed_data.Uint8List blockBodyDescriptor = $convert.base64Decode(
    ...
    'RlbHMuVHJhbnNhY3Rpb25JZFIOdHJhbnNhY3Rpb25JZHMSVgoTcmV3YXJkVHJhbnNhY3Rpb25J'
    'ZBgCIAEoCzIkLmNvLnRvcGwuYnJhbWJsLm1vZGVscy5UcmFuc2FjdGlvbklkUhNyZXdhcmRUcm'
    'Fuc2FjdGlvbklk');
...
final $typed_data.Uint8List fullBlockBodyDescriptor = $convert.base64Decode(
    ...
    '1vZGVscy50cmFuc2FjdGlvbi5Jb1RyYW5zYWN0aW9uUgx0cmFuc2FjdGlvbnMSXgoRcmV3YXJk'
    'VHJhbnNhY3Rpb24YAiABKAsyMC5jby50b3BsLmJyYW1ibC5tb2RlbHMudHJhbnNhY3Rpb24uSW'
    '9UcmFuc2FjdGlvblIRcmV3YXJkVHJhbnNhY3Rpb24=');
