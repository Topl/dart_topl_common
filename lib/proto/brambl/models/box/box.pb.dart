...
class Box extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Box', package: const $pb.PackageName(_omitMessageNames ? '' : 'co.topl.brambl.models.box'), createEmptyInstance: create)
    ..aOM<$20.Lock>(1, _omitFieldNames ? '' : 'lock', subBuilder: $20.Lock.create)
    ..aOM<$23.Value>(2, _omitFieldNames ? '' : 'value', subBuilder: $23.Value.create)
  ...
  @$pb.TagNumber(1)
  $20.Lock get lock => $_getN(0);
  @$pb.TagNumber(1)
  set lock($20.Lock v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLock() => $_has(0);
  @$pb.TagNumber(1)
  void clearLock() => clearField(1);
  @$pb.TagNumber(1)
  $20.Lock ensureLock() => $_ensure(0);

  @$pb.TagNumber(2)
  $23.Value get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($23.Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $23.Value ensureValue() => $_ensure(1);
}
