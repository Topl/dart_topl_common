...
class TokenServiceClient extends $grpc.Client {
  static final _$getGroupPolicy = $grpc.ClientMethod<$1.QueryByGroupIdRequest, $1.GroupPolicyResponse>(
      '/co.topl.genus.services.TokenService/getGroupPolicy',
      ($1.QueryByGroupIdRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GroupPolicyResponse.fromBuffer(value));
  static final _$getSeriesPolicy = $grpc.ClientMethod<$1.QueryBySeriesIdRequest, $1.SeriesPolicyResponse>(
      '/co.topl.genus.services.TokenService/getSeriesPolicy',
      ($1.QueryBySeriesIdRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.SeriesPolicyResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.GroupPolicyResponse> getGroupPolicy($1.QueryByGroupIdRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getGroupPolicy, request, options: options);
  }

  $grpc.ResponseFuture<$1.SeriesPolicyResponse> getSeriesPolicy($1.QueryBySeriesIdRequest request, {$grpc.CallOptions? options}) {
...
abstract class TokenServiceBase extends $grpc.Service {
  ...
  TokenServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.QueryByGroupIdRequest, $1.GroupPolicyResponse>(
        'getGroupPolicy',
        getGroupPolicy_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.QueryByGroupIdRequest.fromBuffer(value),
        ($1.GroupPolicyResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.QueryBySeriesIdRequest, $1.SeriesPolicyResponse>(
        'getSeriesPolicy',
        getSeriesPolicy_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.QueryBySeriesIdRequest.fromBuffer(value),
        ($1.SeriesPolicyResponse value) => value.writeToBuffer()));
  }

  $async.Future<$1.GroupPolicyResponse> getGroupPolicy_Pre($grpc.ServiceCall call, $async.Future<$1.QueryByGroupIdRequest> request) async {
    return getGroupPolicy(call, await request);
  }

  $async.Future<$1.SeriesPolicyResponse> getSeriesPolicy_Pre($grpc.ServiceCall call, $async.Future<$1.QueryBySeriesIdRequest> request) async {
    return getSeriesPolicy(call, await request);
  }

  $async.Future<$1.GroupPolicyResponse> getGroupPolicy($grpc.ServiceCall call, $1.QueryByGroupIdRequest request);
  $async.Future<$1.SeriesPolicyResponse> getSeriesPolicy($grpc.ServiceCall call, $1.QueryBySeriesIdRequest request);
}
