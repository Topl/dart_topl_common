...
/// Descriptor for `QueryByGroupIdRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryByGroupIdRequestDescriptor = $convert.base64Decode(
    'ChVRdWVyeUJ5R3JvdXBJZFJlcXVlc3QSQgoHZ3JvdXBJZBgBIAEoCzIeLmNvLnRvcGwuYnJhbW'
    'JsLm1vZGVscy5Hcm91cElkQgj6QgWKAQIQAVIHZ3JvdXBJZA==');

@$core.Deprecated('Use groupPolicyResponseDescriptor instead')
const GroupPolicyResponse$json = {
  '1': 'GroupPolicyResponse',
  '2': [
    {'1': 'groupPolicy', '3': 1, '4': 1, '5': 11, '6': '.co.topl.brambl.models.Event.GroupPolicy', '10': 'groupPolicy'},
  ],
};

/// Descriptor for `GroupPolicyResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List groupPolicyResponseDescriptor = $convert.base64Decode(
    'ChNHcm91cFBvbGljeVJlc3BvbnNlEkoKC2dyb3VwUG9saWN5GAEgASgLMiguY28udG9wbC5icm'
    'FtYmwubW9kZWxzLkV2ZW50Lkdyb3VwUG9saWN5Ugtncm91cFBvbGljeQ==');

@$core.Deprecated('Use queryBySeriesIdRequestDescriptor instead')
const QueryBySeriesIdRequest$json = {
  '1': 'QueryBySeriesIdRequest',
  '2': [
    {'1': 'seriesId', '3': 1, '4': 1, '5': 11, '6': '.co.topl.brambl.models.SeriesId', '8': {}, '10': 'seriesId'},
  ],
};

/// Descriptor for `QueryBySeriesIdRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryBySeriesIdRequestDescriptor = $convert.base64Decode(
    'ChZRdWVyeUJ5U2VyaWVzSWRSZXF1ZXN0EkUKCHNlcmllc0lkGAEgASgLMh8uY28udG9wbC5icm'
    'FtYmwubW9kZWxzLlNlcmllc0lkQgj6QgWKAQIQAVIIc2VyaWVzSWQ=');

@$core.Deprecated('Use seriesPolicyResponseDescriptor instead')
const SeriesPolicyResponse$json = {
  '1': 'SeriesPolicyResponse',
  '2': [
    {'1': 'seriesPolicy', '3': 1, '4': 1, '5': 11, '6': '.co.topl.brambl.models.Event.SeriesPolicy', '10': 'seriesPolicy'},
  ],
};

/// Descriptor for `SeriesPolicyResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List seriesPolicyResponseDescriptor = $convert.base64Decode(
    'ChRTZXJpZXNQb2xpY3lSZXNwb25zZRJNCgxzZXJpZXNQb2xpY3kYASABKAsyKS5jby50b3BsLm'
    'JyYW1ibC5tb2RlbHMuRXZlbnQuU2VyaWVzUG9saWN5UgxzZXJpZXNQb2xpY3k=');
